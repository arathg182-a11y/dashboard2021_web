...
def exportar_ventas_excel(request):
    ...
    ws = wb.active
    ws.title = 'Ventas'
    ws.append(['Folio', 'Fecha', 'Cliente', 'Sucursal', 'Vendedor', 'Método de Pago', 'Subtotal', 'Impuesto', 'Total'])
    for v in ventas:
        ws.append([
            v.folio, str(v.fecha), v.cliente.nombre, v.sucursal.nombre,
            v.vendedor.nombre, v.metodo_pago.nombre,
